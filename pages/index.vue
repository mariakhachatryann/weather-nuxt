<template>
    <div class="flex items-center p-10 flex-col">
        ...
        <div class="pt-[10px] pb-[50px]">
            <form action="#" class="flex flex-nowrap rounded-[30px] outline-none my-5" @submit.prevent="findLocation(location)">
        ...
        <DetailsPart v-if="getLocation && !isLoading" :location="weatherDetails" @findMyLoc="findUserLocation" />
        <Loader v-if="isLoading" />
        <UnselectedLoc v-if="!isLoading && !getLocation" />
    </div>
</template>
