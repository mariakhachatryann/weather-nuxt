...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="80px" viewBox="0 0 512 512">
        <defs>
            <linearGradient id="meteoconsCloudyFill0" x1="99.5" x2="232.6" y1="30.7" y2="261.4"
            ...
            <path fill="#fff" stroke="#e6effc" stroke-miterlimit="10" stroke-width="6"
    ...
    <use width="350" height="222" href="#meteoconsCloudyFill1" transform="translate(81 145)">
        <animateTransform additive="sum" attributeName="transform" dur="6s" repeatCount="indefinite" type="translate"
            values="-18 0; 18 0; -18 0"></animateTransform>
    </use>
</svg></template>
  
<script>
export default {
    name: 'MeteoconsCloudyFill'
}
</script>