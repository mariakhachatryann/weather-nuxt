...
<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="80px" height="80px" viewBox="0 0 512 512">
        <defs>
            <linearGradient id="meteoconsClearDayFill0" x1="150" x2="234" y1="119.2" y2="264.8"
            ...
            <circle cx="192" cy="192" r="84" fill="#fbbf24" stroke="#f8af18" stroke-miterlimit="10"
            ...
            <path fill="none" stroke="#fbbf24" stroke-linecap="round" stroke-miterlimit="10" stroke-width="24"
                ...
                <animateTransform additive="sum" attributeName="transform" dur="6s" repeatCount="indefinite"
                    type="rotate" values="0 192 192; 45 192 192"></animateTransform>
            </path>
        </symbol>
    </defs>
    <use width="384" height="384" href="#meteoconsClearDayFill1" transform="translate(64 64)"></use>
</svg></template>
  
<script>
export default {
    name: 'MeteoconsClearDayFill'
}
</script>